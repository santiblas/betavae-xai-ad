...
ablation_canales.py
-------------------
Orquestador para análisis de ablación de canales sobre run_vae_clf_ad_ablation.py.
...
Requisitos:
- Tu run_vae_clf_ad_ablation.py accesible (mismo entorno con PyTorch, Optuna, etc.).
"""
...
def main():
    ...
    p = argparse.ArgumentParser(description="Ablación de canales (greedy) encima de run_vae_clf_ad_ablation.py")
    ...
    p.add_argument(
                        ...
                        help="Ruta a run_vae_clf_ad_ad_ablation.py (relativa al root del repo o absoluta)"
                    )
