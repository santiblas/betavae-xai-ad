...
# --- BLOQUE PARA AÑADIR src/ AL sys.path AUTOMÁTICAMENTE ---
import sys
...
if __name__ == "__main__":
    ...
    group_clf.add_argument("--gridsearch_scoring", type=str, default="balanced_accuracy", help="Métrica para la búsqueda de HP (OptunaSearchCV).")
